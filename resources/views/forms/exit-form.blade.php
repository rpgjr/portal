        ...
        <div class="row mx-4 justify-content-center">
            <div class="col-md-10">
                <div class="row box-forms align-items-center">
                    ...
                    <div class="col-md-12">
                        {{-- Start of Form --}}
                        <form action="{{ route('user.exitAnswers') }}" method="post">
                        @csrf
                        {{-- start of Carousel --}}
                        <div id="carouselExampleControls" class="carousel carousel-dark slide" data-bs-ride="false" data-bs-wrap="false">
                            <div class="carousel-inner">
                                <div class="carousel-item active"> @include('forms.exitP1') </div>
                                <div class="carousel-item"> @include('forms.exitP2') </div>
                                <div class="carousel-item"> @include('forms.exitP3') </div>
                                <div class="carousel-item"> @include('forms.exitP4') </div>
                                <div class="carousel-item"> @include('forms.exitP5') </div>
                            </div>
